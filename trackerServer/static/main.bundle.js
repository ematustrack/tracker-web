...
var DataTableService = (function () {
    function DataTableService(http) {
        this.http = http;
        this.Url = 'http://127.0.0.1:8000'; //'http://54.175.253.151';  // URL to web api
